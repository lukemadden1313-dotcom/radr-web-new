...
export function EditProfileForm({
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      const result = await updateProfile({ full_name: fullName, username, bio });
      if (result.error) {
      ...
      setSaved(true);
      setTimeout(() => {
        router.push(`/profile/${result.username ?? username}`);
      }, 600);
    });
  }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="px-6 mt-8 flex flex-col items-center gap-3">
            ...
            fallback={
              <span
                ...
                style={{
                  width: avatarSize,
                  height: avatarSize,
                  background: avatarGradient(gradientSeed),
        ...
        {/* Avatar upload not wired — needs Supabase storage bucket */}
        <button
